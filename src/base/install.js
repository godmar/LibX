// XpiInstaller
// By Richard Karnesky (Heavily inspired by code from Henrik Gemal and Stephen Clavering)

var XpiInstaller = {

	// --- Editable items begin ---
	extFullName: '$emname$', // The name displayed to the user (don't include the version)
	extShortName: 'libx', // The leafname of the JAR file (without the .jar part)
	extVersion: '$libxversion$',
	extAuthor: 'Annette Bailey',
	...
	install: function()
	{
		...
		// Add Directory
		Install.addDirectory(null, 'chrome', installPath, null);
