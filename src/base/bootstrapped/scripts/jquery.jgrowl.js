...
(function($) {
	...
	$.extend( $.fn.jGrowl.prototype , {
		...
		defaults: {
			...
			easing: 		'swing',
			closer: 		true,
			closeTemplate: 'x', // &times; not supported by XHTML
		...
		notification: 	function( message , o ) {
			...
			var notification = $('<div class="jGrowl-notification" width="' + o.width + '"><div class="close">' + o.closeTemplate + '</div><div class="header">' + o.header + '</div><div class="message"></div></div>')
            ...
            notification.find('.message').append(message);
