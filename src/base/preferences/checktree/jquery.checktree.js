...
jQuery.fn.checkTree = function(settings) {
    ...
    settings = jQuery.extend({
        ...
        */
        ...
        /* Valid choices: 'custom', 'expand', 'check' */
        labelAction: "expand",
        ...
        .find(":checkbox")
            .change(function(e, dontDoCallback) {
                ...
                if ($all.length == $checked.length) {
                    ...
                    if (!dontDoCallback && settings.onCheck) settings.onCheck(jQuery(this).parent());
                }
                ...
                // All children are unchecked
                    ...
                    if (!dontDoCallback && settings.onUnCheck) settings.onUnCheck(jQuery(this).parent());
                }
                ...
                // Some children are checked, makes the parent in a half checked state.
                    ...
                    if (!dontDoCallback && settings.onHalfCheck && !jQuery(this).siblings(".checkbox").hasClass("half_checked"))
