 ...
 * @type String
 */
function TestDecorator_toString() { return "WOOOOOOOOOOOOO" + this.mTest.toString(); }
...
{ 
    this.testEnded( test.toString() + "\r"); 
}
/**
...
{
    this.getWriter().println( count + ") " + defect.toString());
}
/**
...
function ResultPrinter_startTest( test )
{
    ...
    {
		println("## RecordOutput_Begin: "+ test);
		if( this.mColumn++ >= 39 )
        {
            this.getWriter().println("\n");
            this.mColumn = 0;
